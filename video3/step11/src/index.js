/**
 * Now the designers want divs instead of tables.
 *
 * But we can't break any of the existing scripts.
 *
 * We're going to start with a test showing that we're able to use divs as an optional configuration.
 * Then we'll replace the logic to useDivs.
 */
