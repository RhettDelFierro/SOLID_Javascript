import {Paint} from '../../step17/src'
import {PaintReport} from '../../step17/src/paint-report'
import {PaintStore} from '../../step17/src/paint-store'
import {DivFormatter} from '../../step17/src/formatter'
  ...
  describe('rendering a report', () => {
    ...
    it('uses divs', () => {
      const expected =
        ...
        '</div>'
      expect(paint.generateReport({reverseColumns: true, prices: prices, formatter: new DivFormatter()})).toEqual(expected);
    })
  })
})
